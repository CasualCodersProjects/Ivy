...
//15925775/1461680/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LMR54406DBVR" (originalName "LMR54406DBVR")
	...
	(compDef "LMR54406DBVR" (originalName "LMR54406DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "CB") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "6" (pinName "SW") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VIN") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "EN") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LMR54406DBVR"))
		...
		(attr "Mouser Part Number" "595-LMR54406DBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LMR54406DBVR?qs=rSMjJ%252B1ewcQLNU8KVBwgHQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "LMR54406DBVR")
		(attr "Description" "Switching Voltage Regulators SIMPLE SWITCHER power converter 4.5-V to 36-V, 0.6-A, synchronous buck with 80-uA IQ")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/lmr54406.pdf?ts=1659688249350&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FLMR54406%252Fpart-details%252FLMR54406DBVR")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "LMR54406DBVR.stp")
